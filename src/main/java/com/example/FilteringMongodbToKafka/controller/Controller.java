...
public class Controller {
    ...
    @Autowired
    private com.example.FilteringMongodbToKafka.mongodb.wikiService wikiService;
    ...
    public ResponseEntity<List<WikiChange>> searchPerson(
        ...
        ResponseEntity<List<WikiChange>> reponse = ResponseEntity.ok().body(wikiService.fetchWikisByProperties(type, user, bot, namespace, monid, domain, page));
